...
class DeliverableItemsController {
  private DeliverableItemsService = new DeliverableItemsService();
  ...
  public synchronizeDown = async (
    ...
    try {
      ...
      const data = await this.DeliverableItemsService.synchronizeDown(
  ...
  public synchronizeUp = async (
    ...
    try {
      ...
      const data = await this.DeliverableItemsService.synchronizeUp(req.body);
...
export default DeliverableItemsController;
